    ...
    <div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
      <div class="md:w-1/2 px-8 md:px-16">
        ...
        <form class="flex flex-col gap-4" @submit.prevent="signIn">
          <input v-model="email" class="p-2 mt-8 rounded-xl border" type="email" name="email" placeholder="Email">
          <div class="relative">
        ...
        <UButton color="black" :ui="{ rounded: 'rounded-xl' }" icon="i-simple-icons-google" label="Login com Google"
        ...
        <UButton icon="i-simple-icons-github" type="button" color="black"
      ...
      <div class="md:block hidden w-1/2">
        <img class="rounded-2xl" src="/images/login.jpg">
      </div>
    </div>
  </section>
</template>
